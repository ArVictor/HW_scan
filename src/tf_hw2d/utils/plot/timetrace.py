...
from tf_hw2d.utils.plot.movie import get_extended_viridis

from tf_hw2d.utils.latex_format import latex_format
...
def plot_timetraces(
    ...
    with h5py.File(file_path, "r") as hf:
        ...
        for property in properties:
            ...
            if hf[property].shape[0] > t0_std_idx:
        ...
        out_path = out_path.replace("enstrophy-energy", "EE")
        out_path = out_path.replace("kinetic_energy", "KE")
        out_path = out_path.replace("thermal_energy", "TE")
        out_path = out_path.replace("thermal_energy", "TE")
        out_path = out_path.replace("gamma_n", "GN")
        out_path = out_path.replace("gamma_c", "GC")
